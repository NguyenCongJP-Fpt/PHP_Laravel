    ...
    public function run()
    {
        ...
        DB::table('categories')->insert([
            ...
            [
                'id'=>4,
                'name'=>'Bánh ăn sáng',
                'description'=>'Bánh ăn thường ngày',
                'images'=>'https://i.ytimg.com/vi/pQNApnQK4Xo/maxresdefault.jpg'
            ],
            [
                'id'=>5,
                'name'=>'Bánh ăn vặt',
                'description'=>'Bánh ăn vặt',
                'images'=>'http://onlinetravel.company/wp-content/uploads/2017/11/Banhxeo-0.jpg'
            ]
        ]);
