                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <div class="single-item">
                                        <div class="single-item-header">
                                            <a href="source/product.html"><img
                                                        src="source/assets/dest/images/products/1.jpg"
                                                        alt=""></a>
                                        </div>
                                ...
                                <div class="col-sm-3">
                                    <div class="single-item">
                                        ...
                                        <div class="single-item-header">
                                            <a href="source/product.html"><img
                                                        src="source/assets/dest/images/products/2.jpg"
                                                        alt=""></a>
                                        </div>
                                        <div class="single-item-body">
                                            <p class="single-item-title">Sample Woman Top</p>
                                ...
                                <div class="col-sm-3">
                                    <div class="single-item">
                                        <div class="single-item-header">
                                            <a href="source/product.html"><img
                                                        src="source/assets/dest/images/products/3.jpg"
                                                        alt=""></a>
                                        </div>
                                        <div class="single-item-body">
                                            <p class="single-item-title">Sample Woman Top</p>
