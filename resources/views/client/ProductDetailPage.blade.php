        ...
        <div class="container">
            ...
            <div class="pull-right">
                <div class="beta-breadcrumb font-large">
                    <a href="source/index.html">Home</a> / <span>Product</span>
                </div>
            </div>
                    ...
                    <div class="beta-products-list">
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="single-item">
                                    <div class="single-item-header">
                                        <a href="source/product.html"><img src="source/assets/dest/images/products/4.jpg" alt=""></a>
                                    </div>
                                    <div class="single-item-body">
                                        <p class="single-item-title">Sample Woman Top</p>
                                        <p class="single-item-price">
                                    ...
                                    <div class="single-item-caption">
                                        <a class="add-to-cart pull-left" href="source/product.html"><i
                            ...
                            <div class="col-sm-4">
                                <div class="single-item">
                                    <div class="single-item-header">
                                        <a href="source/product.html"><img src="source/assets/dest/images/products/5.jpg" alt=""></a>
                                    </div>
                                    <div class="single-item-body">
                                        <p class="single-item-title">Sample Woman Top</p>
                                        <p class="single-item-price">
                        ...
                        <div class="widget-body">
                            <div class="beta-sales beta-lists">
                                <div class="media beta-sales-item">
                                    <a class="pull-left" href="source/product.html"><img
